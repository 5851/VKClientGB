...
class GroupDetailHorizontalCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        imageView.anchor(top: titleLabel.bottomAnchor, leading: leadingAnchor, bottom: bottomAnchor, trailing: trailingAnchor, padding: .init(top: 10, left: 16, bottom: 0, right: 16))
